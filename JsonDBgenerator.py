...
#
# # Generate 50 dummy User entries
# dummy_users = generate_data(200, generate_user)
#
# # Generate 50 dummy Post entries for 10 users
# dummy_posts = generate_data(500, generate_post, 10)  # Assuming 10 users
#
# # Generate 50 dummy Comment entries
# dummy_comments = generate_data(500, generate_comment, dummy_posts, dummy_users)
#
# # Generate 50 dummy FriendRequest entries
# dummy_friend_requests = generate_data(300, generate_friend_request, dummy_users, dummy_users)
#
# # Generate 50 dummy Like entries
# dummy_likes = generate_data(700, generate_like, dummy_users, dummy_posts)
#
# # Generate 50 dummy Share entries
# dummy_shares = generate_data(300, generate_share, dummy_users, dummy_posts)
#
# # Generate 50 dummy Message entries
# dummy_messages = generate_data(200, generate_message, dummy_users, dummy_users)
#
# # Generate 50 dummy Group entries
# dummy_groups = generate_data(50, generate_group)
#
# # Generate 50 dummy Page entries
# dummy_pages = generate_data(50, generate_page)
#
# # Generate 50 dummy Event entries
# dummy_events = generate_data(70, generate_event, dummy_users)
#
# # Generate 50 dummy Hashtag entries
# dummy_hashtags = generate_data(600, generate_hashtag)
#
# # Generate 50 dummy Notification entries
# dummy_notifications = generate_data(200, generate_notification, dummy_users)
#
# # Generate 50 dummy Poll entries
# dummy_polls = generate_data(50, generate_poll, dummy_users)
#
# # Generate 50 dummy PollOption entries
# dummy_poll_options = generate_data(500, generate_poll_option, dummy_polls)
#
# # Generate 50 dummy Album entries
# dummy_albums = generate_data(50, generate_album, dummy_users)
#
# # Generate 50 dummy Photo entries
# dummy_photos = generate_data(60, generate_photo, dummy_albums, dummy_users)
#
# # Generate 50 dummy Video entries
# dummy_videos = generate_data(50, generate_video, dummy_users)
#
# # Combine the generated data for all entities into a single dictionary
# dummy_data = {
#     "users": dummy_users,
#     "posts": dummy_posts,
#     "comments": dummy_comments,
#     "friend_requests": dummy_friend_requests,
#     "likes": dummy_likes,
#     "shares": dummy_shares,
...
#     "polls": dummy_polls,
#     "poll_options": dummy_poll_options,
#     "albums": dummy_albums,
#     "photos": dummy_photos,
#     "videos": dummy_videos
# }
